...
def closest_unit_index_to(
    units: Units, target_position: Union[Point2, Tuple[float, float]]
) -> int: ...
...
def find_center_mass(
    units: Units, distance: float, default_position: Union[List[float], Point2]
...
def make_bounding_circle(points: List[List[float]]) -> Tuple[float, float, float]: ...
